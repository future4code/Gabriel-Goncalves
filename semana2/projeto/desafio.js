 ...
 */
       ...
       if(cartaJogador1 && cartaJogador2 === 'A') {
         ...
         'Deseja comprar mais uma carta?')) { 
           ...
           if(pontuacaoJogador > 21) {
              ...
              Suas cartas são ${cartaJogador1.texto} ${cartaJogador2.texto} ${cartaJogador3.texto} sua pontuação é ${pontuacaoJogador}.` + "/n" + `As cartas do computador são ${cartaComputador1.texto} ${cartaComputador2.texto}.`)
    ...
    if(confirm(`Suas cartas são: ${cartaJogador1.texto} e ${cartaJogador2.texto}. Uma carta do computador é ${cartaComputador1.texto}. Deseja comprar mais uma carta?`)) { 
       let cartaJogador3 = comprarCarta()
       pontuacaoJogador += cartaJogador3.valor
      //  console.log(pontuacaoJogador)
      if(pontuacaoJogador > 21) {
